...
class ProductCategory(models.Model):
    ...
    catalog = models.ForeignKey(ProductCatalog, on_delete=models.SET_NULL, null = True, related_name="categories")
...
class Product(models.Model):
    ...
    product_id = models.UUIDField(default=uuid.uuid4, unique=True, blank=False, null=False, editable=False)
    ...
    description = models.TextField()
    long_description = models.TextField() # TODO: add another models for this field.
    ...
    merchant = models.OneToOneField(Merchant, blank=True, null=True, on_delete=models.CASCADE)
